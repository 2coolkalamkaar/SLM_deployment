...
|---|---|---|---|
| **TypeScript Caller Worker** | `t3.medium` | `3111` (HTTP) | accepts OpenAI-style HTTP/JSON requests |
| **iii-engine** | _(runs on TS instance)_ | `49134` (WebSocket) |  routes messages between workers |
| **Python Inference Worker** | `t3.medium` | `49134` (WebSocket out) |  loads AI model and generates text |
